<?php
/*--------------------------------------------------------------------*
 | Copyright (c) 2010-2017 Vayer Software Ltd. - All Rights Reserved. |
 *--------------------------------------------------------------------*/
...
public function query($sql, $params = null, $flags = 0, $wantFields = null, $offset = 0, $limit = 0) {
    ...
    // Ensure $wantFields is an array (empty array if it's null)
    $wantFields = is_array($wantFields) ? array_flip($wantFields) : array();
